...
<table><tbody><tr><td><strong>python notes.py</strong> add --title “новая заметка” –msg “тело новой заметки”</td></tr></tbody></table>

или так:


<table><tbody><tr><td><p><strong>python note.py&nbsp;</strong></p><p>Введите команду: add</p><p>Введите заголовок заметки: новая заметка</p><p>Введите тело заметки: тело новой заметки</p><p>Заметка успешно сохранена</p><p>Введите команду:</p></td></tr></tbody></table>
